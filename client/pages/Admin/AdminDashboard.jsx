      ...
      <div className="admin-sections">
        ...
        <div className="admin-section">
          <div className="section-header">
            ...
            <h3>Exportar Dispatcher</h3>
          </div>
          <div className="section-items">
            <Link to="/admin/export" className="section-item">
              <div className="item-icon" style={{ background: 'linear-gradient(135deg, #22c55e, #16a34a)' }}>
                <span className="material-icons" style={{ color: '#fff' }}>download</span>
              </div>
              <div className="item-content">
                <div className="item-title">Exportar a Excel</div>
                <div className="item-subtitle">Elige estados, filtros y columnas a incluir</div>
              </div>
              <span className="material-icons item-arrow">chevron_right</span>
            </Link>
          </div>
