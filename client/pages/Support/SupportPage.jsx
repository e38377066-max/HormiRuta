    ...
    <div className="support-page">
      ...
      <main className="support-main">
        ...
        <div className="support-grid">
          <a
            className="support-card support-whatsapp"
            href="https://wa.me/18622862862"
            target="_blank"
          ...
          <a
            className="support-card support-email"
            href="mailto:admin@area862system.com"
          >
            <span className="support-card-icon">
              <span className="material-icons" style={{ fontSize: 36 }}>email</span>
            </span>
            <div className="support-card-text">
          ...
          <a
            className="support-card support-web"
            href="https://area862system.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="support-card-icon">
              <span className="material-icons" style={{ fontSize: 36 }}>language</span>
            </span>
            <div className="support-card-text">
        ...
        <div className="support-info-card">
          <span className="material-icons" style={{ color: '#64748b', fontSize: 20 }}>schedule</span>
          <p>{t('support.hours')}</p>
        </div>
      </main>
    </div>
