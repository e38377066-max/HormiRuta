      ...
      <main className="support-main">
        ...
        <section className="support-section">
          ...
          <div className="support-grid">
            <a className="support-card support-whatsapp" href="https://wa.me/14696843174" target="_blank" rel="noopener noreferrer">
            ...
            <a className="support-card support-email" href="mailto:felipedelgado2006@gmail.com">
              <span className="support-card-icon">
                <span className="material-icons" style={{ fontSize: 30 }}>email</span>
              </span>
              <div className="support-card-text">
                <h3>{t('support.emailTitle')}</h3>
                <p>felipedelgado2006@gmail.com</p>
        ...
        <section className="support-section">
          ...
          <div className="support-about-card">
            ...
            <div className="support-about-row">
              ...
              <span>felipedelgado2006@gmail.com</span>
            </div>
            <div className="support-about-row">
