...
Route.prototype.toDict = async function() {
  ...
  return {
    ...
    pickup_admin_confirmed_at: this.pickup_admin_confirmed_at,
    pickup_admin_confirmed_by: this.pickup_admin_confirmed_by,
    pickup_driver_confirmed_at: this.pickup_driver_confirmed_at,
